...
public:
    clsDeveloper(int ID, string FirstName, string LastName, string Title, string Email, string Phone, int Salary, string Department, string MainProgrammingLanguage)
